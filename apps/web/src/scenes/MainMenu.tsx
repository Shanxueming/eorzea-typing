...
export function MainMenu({ onStartSolo, onGoCoop, victoryCount }: MainMenuProps) {
  ...
  const startQuick = async () => {
    ...
    try {
      ...
      onStartSolo({ pool, mode, difficulty });
    } catch (e) {
      setError(String(e));
    } finally {
      setBusy(false);
  ...
  return (
    <div className="menu">
      ...
      <div className="menu__community">玩家群 · <strong>143232747</strong></div>
